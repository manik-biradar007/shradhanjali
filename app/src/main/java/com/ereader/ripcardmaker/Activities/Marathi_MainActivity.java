...
public class Marathi_MainActivity extends AppCompatActivity {
    class AnonymousClass15 implements View.OnClickListener {
        ...
        public void onClick(View view) {
            Marathi_MainActivity.this.death_card_maker_rip_downloads();
            final Handler handler = new Handler() {
                @Override
                public void handleMessage(Message message) {
                    super.handleMessage(message);
                    Marathi_MainActivity.this.death_card_maker_rip_progressDialog.incrementProgressBy(10);
                }
            };
            Marathi_MainActivity.this.death_card_maker_rip_progressDialog = new ProgressDialog(
                    Marathi_MainActivity.this);
            Marathi_MainActivity.this.death_card_maker_rip_progressDialog.setMax(100);
            Marathi_MainActivity.this.death_card_maker_rip_progressDialog.setMessage("Loading...");
            Marathi_MainActivity.this.death_card_maker_rip_progressDialog.setTitle("Image Save...");
            Marathi_MainActivity.this.death_card_maker_rip_progressDialog.setProgressStyle(1);
            Marathi_MainActivity.this.death_card_maker_rip_progressDialog.show();
            Marathi_MainActivity.this.death_card_maker_rip_progressDialog.setCancelable(false);
            new Thread(new Runnable() {
                @Override
                public void run() {
                    while (Marathi_MainActivity.this.death_card_maker_rip_progressDialog
                            .getProgress() <= Marathi_MainActivity.this.death_card_maker_rip_progressDialog.getMax()) {
                        try {
                            Thread.sleep(200L);
                            Handler handler2 = handler;
                            handler2.sendMessage(handler2.obtainMessage());
                            if (Marathi_MainActivity.this.death_card_maker_rip_progressDialog
                                    .getProgress() == Marathi_MainActivity.this.death_card_maker_rip_progressDialog
                                            .getMax()) {
                                Marathi_MainActivity.this.death_card_maker_rip_progressDialog.dismiss();
                            }
                        } catch (Exception e) {
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    Intent intent6 = new Intent(Marathi_MainActivity.this, Save_Image_Activity.class);
                    intent6.putExtra("img", Marathi_MainActivity.this.death_card_maker_rip_name);
                    Marathi_MainActivity.this.startActivity(intent6);
    ...
    class AnonymousClass20 implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView adapterView, View view, final int i, long j) {
            ...
            Marathi_MainActivity.this.death_card_maker_rip_diya_layout.setVisibility(View.GONE);
            Marathi_MainActivity.this.death_card_maker_rip_maindiya0
                    .setImageResource(Marathi_MainActivity.this.death_card_maker_rip_divaarray[i]);
            Marathi_MainActivity.this.death_card_maker_rip_maindiya1
                    .setImageResource(Marathi_MainActivity.this.death_card_maker_rip_divaarray[i]);
    ...
    class AnonymousClass21 implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView adapterView, View view, final int i, long j) {
            ...
            Marathi_MainActivity.this.death_card_maker_rip_ring_layout.setVisibility(View.GONE);
            Marathi_MainActivity.this.death_card_maker_rip_ring_img
                    .setImageResource(Marathi_MainActivity.this.death_card_maker_rip_ringarray[i]);
    ...
    class AnonymousClass22 implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView adapterView, View view, final int i, long j) {
            ...
            Marathi_MainActivity.this.death_card_maker_rip_bg_layout.setVisibility(View.GONE);
            Marathi_MainActivity.this.death_card_maker_rip_framebg_img
                    .setImageResource(Marathi_MainActivity.this.death_card_maker_rip_framearray[i]);
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.marathi_main_activity);
        ...
        Marathi_MainActivity.this.death_card_maker_rip_form3Gone.setVisibility(View.GONE);
        ...
        Marathi_MainActivity.this.death_card_maker_rip_detail_form1.setVisibility(View.GONE);
        this.death_card_maker_rip_detail_form2 = (LinearLayout) findViewById(R.id.detail_form2);
        Marathi_MainActivity.this.death_card_maker_rip_detail_form2.setVisibility(View.GONE);
        ...
        Marathi_MainActivity.this.death_card_maker_rip_detail_form3.setVisibility(View.VISIBLE);
        ...
        this.death_card_maker_rip_ttff1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Marathi_MainActivity.this.death_card_maker_rip_form1_detail_1();
            }
        });
        this.death_card_maker_rip_ttff2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Marathi_MainActivity.this.death_card_maker_rip_form2_detail_2();
            }
        });
        this.death_card_maker_rip_ttff3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Marathi_MainActivity.this.death_card_maker_rip_form3_detail_3();
            }
        });
        ...
        this.death_card_maker_rip_Ring.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Marathi_MainActivity.this.death_card_maker_rip_ring_layout.setVisibility(View.VISIBLE);
            }
        });
        this.death_card_maker_rip_bgframe_color.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Marathi_MainActivity.this.death_card_maker_rip_bgframe_colorlayout.setVisibility(View.VISIBLE);
            }
        });
        this.color.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ColorPickerDialogBuilder.with(Marathi_MainActivity.this).setTitle(R.string.color_dialog_title)
                        .initialColor(Marathi_MainActivity.this.currentBackgroundColor)
                        ...
                        .setOnColorChangedListener(new OnColorChangedListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i, Integer[] numArr) {
                                Marathi_MainActivity.this.death_card_maker_rip_framebg_img.setColorFilter(i);
                                if (numArr != null) {
                                    ...
                                    if (sb != null) {
                                        Toast.makeText(Marathi_MainActivity.this.getApplicationContext(), sb.toString(),
                        ...
                        .setColorEditTextColor(
                                ContextCompat.getColor(Marathi_MainActivity.this, android.R.color.holo_blue_bright))
                        .build().show();
            }
        });
        this.death_card_maker_rip_bg_frame.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Marathi_MainActivity.this.death_card_maker_rip_bg_layout.setVisibility(View.VISIBLE);
            }
        });
        this.death_card_maker_rip_bgframe_color.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        this.death_card_maker_rip_Divoclick.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Marathi_MainActivity.this.death_card_maker_rip_diya_layout.setVisibility(View.VISIBLE);
            }
        });
        ...
        linearLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (Marathi_MainActivity.death_card_maker_rip_click) {
                    Marathi_MainActivity.this.fontsizes();
                } else {
                    Toast.makeText(Marathi_MainActivity.this, "First now form submit then font size change",
                            Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        this.death_card_maker_rip_select_photo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Marathi_MainActivity.this.startActivityForResult(
                        new Intent("android.intent.action.PICK", MediaStore.Images.Media.EXTERNAL_CONTENT_URI),
                        Marathi_MainActivity.RESULT_LOAD_IMAGE);
            }
        });
        ...
        this.death_card_maker_rip_jjbg_gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView adapterView, View view, int i6, long j) {
                Marathi_MainActivity.this.death_card_maker_rip_bgframe_colorlayout.setVisibility(View.GONE);
                Marathi_MainActivity.this.death_card_maker_rip_jjbg_img
                        .setImageResource(Marathi_MainActivity.this.death_card_maker_rip_bgringarray_color[i6]);
            }
        });
        this.death_card_maker_rip_bg_gridview.setAdapter(
                (ListAdapter) new ImageAdapter(getApplicationContext(), this.death_card_maker_rip_arrayListbg));
        ...
        this.death_card_maker_rip_design_frame.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Marathi_MainActivity.this.death_card_maker_rip_design_layout.setVisibility(View.VISIBLE);
            }
        });
        ...
        this.death_card_maker_rip_design_gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView adapterView, View view, int i6, long j) {
                Marathi_MainActivity.this.death_card_maker_rip_design_layout.setVisibility(View.GONE);
                Marathi_MainActivity.this.death_card_maker_rip_design_img
                        .setImageResource(Marathi_MainActivity.this.death_card_maker_rip_dgringarray[i6]);
            }
        });
    }
    ...
    public void fontsizes() {
        ...
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar2) {
                Marathi_MainActivity _Marathi_MainActivity = Marathi_MainActivity.this;
                _Marathi_MainActivity.death_card_maker_rip_prefs = _Marathi_MainActivity.getPreferences(0);
                SharedPreferences.Editor edit = Marathi_MainActivity.this.death_card_maker_rip_prefs.edit();
                edit.putFloat("fontsize", Marathi_MainActivity.this.death_card_maker_rip_Maintext.getTextSize());
                edit.commit();
            }
            ...
            public void onProgressChanged(SeekBar seekBar2, int i, boolean z) {
                float f = i;
                Marathi_MainActivity.this.death_card_maker_rip_Maintext.setTextSize(f);
                Marathi_MainActivity.this.death_card_maker_rip_click_besnu.setTextSize(f);
                Marathi_MainActivity.this.death_card_maker_rip_detaillset.setTextSize(f);
                Marathi_MainActivity.this.death_card_maker_rip_setname1.setTextSize(f);
                Marathi_MainActivity.this.death_card_maker_rip_setname2.setTextSize(f);
                Marathi_MainActivity.this.death_card_maker_rip_setname3.setTextSize(f);
                Marathi_MainActivity.this.death_card_maker_rip_setname4.setTextSize(f);
                Marathi_MainActivity.this.death_card_maker_rip_setname5.setTextSize(f);
                Marathi_MainActivity.this.death_card_maker_rip_setnumber1.setTextSize(f);
                Marathi_MainActivity.this.death_card_maker_rip_setnumber2.setTextSize(f);
                Marathi_MainActivity.this.death_card_maker_rip_setnumber3.setTextSize(f);
                Marathi_MainActivity.this.death_card_maker_rip_setnumber4.setTextSize(f);
                Marathi_MainActivity.this.death_card_maker_rip_setnumber5.setTextSize(f);
            }
        });
    ...
    public void death_card_maker_rip_form1_detail_1() {
        ...
        ((TextView) inflate.findViewById(R.id.mset_btn)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (editText.getText().toString().isEmpty()) {
                    ...
                    Marathi_MainActivity.this.death_card_maker_rip_Maintext
                            .setText("कळविण्यात अत्यंत दुःख होत आहे की, आमचे " + editText2.getText().toString()
                                    + MaskedEditText.SPACE + editText3.getText().toString() + " (वय "
                                    + editText4.getText().toString() + " वर्षे), राहणार "
                                    + editText.getText().toString()
                                    + ", यांचे " + maskedEditText.getText().toString() + MaskedEditText.SPACE
                                    + textView.getText().toString()
                                    + " रोजी दुःखद निधन झाले. परमेश्वर त्यांच्या आत्म्यास चिरशांती देवो, हीच ईश्वर चरणी प्रार्थना.");
                    Marathi_MainActivity.death_card_maker_rip_click = true;
                    Marathi_MainActivity.this.death_card_maker_rip_nameofdeath.setText(editText3.getText().toString());
                    Marathi_MainActivity.this.death_card_maker_rip_nameofdeath
                            .setTextColor(Marathi_MainActivity.this.getResources().getColor(R.color.black));
                    create.dismiss();
                }
            }
        });
        textView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                View inflate2 = LayoutInflater.from(Marathi_MainActivity.this).inflate(R.layout.marathi_war_list,
                        (ViewGroup) null);
                final AlertDialog create2 = new AlertDialog.Builder(Marathi_MainActivity.this).create();
                inflate2.findViewById(R.id.v1).setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view2) {
                        textView.setText("सोमवार");
                        create2.dismiss();
                    }
                });
    ...
    public void death_card_maker_rip_form2_detail_2() {
        ...
        textView.setOnClickListener(view -> {
            if (maskedEditText.getText().toString().isEmpty()) {
                ...
                TextView textView6 = Marathi_MainActivity.this.death_card_maker_rip_detaillset;
                Marathi_MainActivity.this.death_card_maker_rip_click_besnu
                        .setText("दिनांक  " + maskedEditText.getText().toString() + MaskedEditText.SPACE
                                + textView4.getText().toString() + " रोजी  " + textView5.getText().toString()
                                + MaskedEditText.SPACE + editText3.getText().toString() + " वाजता.");
                textView6.setText("पत्ता :- " + editText.getText().toString());
                Marathi_MainActivity.death_card_maker_rip_click = true;
                create.dismiss();
            }
        });
        editText3.setOnClickListener(view -> {
            ...
            TimePickerDialog timePickerDialog = new TimePickerDialog(Marathi_MainActivity.this,
                    (timePicker, i, i2) -> {
                        String.valueOf(i);
        ...
        textView4.setOnClickListener(view -> {
            ...
            inflate2.findViewById(R.id.v1).setOnClickListener(view2 -> {
                textView4.setText("सोमवार");
                create2.dismiss();
            });
            inflate2.findViewById(R.id.v2).setOnClickListener(view2 -> {
                textView4.setText("मंगळवार");
                create2.dismiss();
            });
            inflate2.findViewById(R.id.v3).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view2) {
                    textView4.setText("बुधवार");
                    create2.dismiss();
                }
            });
            inflate2.findViewById(R.id.v4).setOnClickListener(new View.OnClickListener() {
        ...
        textView5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                View inflate2 = LayoutInflater.from(Marathi_MainActivity.this).inflate(R.layout.marathi_smay_list,
                        (ViewGroup) null);
                final AlertDialog create2 = new AlertDialog.Builder(Marathi_MainActivity.this).create();
                inflate2.findViewById(R.id.v1).setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view2) {
                        textView5.setText("संध्याकाळी");
                        create2.dismiss();
                    }
                });
                inflate2.findViewById(R.id.v2).setOnClickListener(new View.OnClickListener() {
    ...
    public void death_card_maker_rip_form3_detail_3() {
        View inflate = LayoutInflater.from(this).inflate(R.layout.marathi_form3, (ViewGroup) null);
        final AlertDialog create = new AlertDialog.Builder(this, R.style.myFullscreenAlertDialogStyle).create();
        ...
        ((TextView) inflate.findViewById(R.id.mset_btn)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (textView.getText().toString().isEmpty()) {
                    ...
                    Marathi_MainActivity.this.death_card_maker_rip_setname1
                            .setTextColor(Marathi_MainActivity.this.getResources().getColor(R.color.black));
                    Marathi_MainActivity.this.death_card_maker_rip_setname1.setText(textView.getText().toString());
                    Marathi_MainActivity.this.death_card_maker_rip_setname2
                            .setTextColor(Marathi_MainActivity.this.getResources().getColor(R.color.black));
                    Marathi_MainActivity.this.death_card_maker_rip_setname2.setText(textView3.getText().toString());
                    Marathi_MainActivity.this.death_card_maker_rip_setname3
                            .setTextColor(Marathi_MainActivity.this.getResources().getColor(R.color.black));
                    Marathi_MainActivity.this.death_card_maker_rip_setname3.setText(textView5.getText().toString());
                    Marathi_MainActivity.this.death_card_maker_rip_setname4
                            .setTextColor(Marathi_MainActivity.this.getResources().getColor(R.color.black));
                    Marathi_MainActivity.this.death_card_maker_rip_setname4.setText(textView7.getText().toString());
                    Marathi_MainActivity.this.death_card_maker_rip_setname5
                            .setTextColor(Marathi_MainActivity.this.getResources().getColor(R.color.black));
                    Marathi_MainActivity.this.death_card_maker_rip_setname5.setText(textView9.getText().toString());
                    Marathi_MainActivity.this.death_card_maker_rip_setnumber1
                            .setTextColor(Marathi_MainActivity.this.getResources().getColor(R.color.black));
                    Marathi_MainActivity.this.death_card_maker_rip_setnumber1.setText(textView2.getText().toString());
                    Marathi_MainActivity.this.death_card_maker_rip_setnumber2
                            .setTextColor(Marathi_MainActivity.this.getResources().getColor(R.color.black));
                    Marathi_MainActivity.this.death_card_maker_rip_setnumber2.setText(textView4.getText().toString());
                    Marathi_MainActivity.this.death_card_maker_rip_setnumber3
                            .setTextColor(Marathi_MainActivity.this.getResources().getColor(R.color.black));
                    Marathi_MainActivity.this.death_card_maker_rip_setnumber3.setText(textView6.getText().toString());
                    Marathi_MainActivity.this.death_card_maker_rip_setnumber4
                            .setTextColor(Marathi_MainActivity.this.getResources().getColor(R.color.black));
                    Marathi_MainActivity.this.death_card_maker_rip_setnumber4.setText(textView8.getText().toString());
                    Marathi_MainActivity.this.death_card_maker_rip_setnumber5
                            .setTextColor(Marathi_MainActivity.this.getResources().getColor(R.color.black));
                    Marathi_MainActivity.this.death_card_maker_rip_setnumber5.setText(textView10.getText().toString());
                    Marathi_MainActivity.death_card_maker_rip_click = true;
                    create.dismiss();
                } else {
                    textView2.setError("");
    ...
    public void onBackPressed() {
        if (this.death_card_maker_rip_bg_layout.getVisibility() == View.VISIBLE) {
            ...
            ((CardView) dialog.findViewById(R.id.tv_dialog_yes_sure)).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Marathi_MainActivity.super.onBackPressed();
                }
            });
