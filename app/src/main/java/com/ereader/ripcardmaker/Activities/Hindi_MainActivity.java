...
public class Hindi_MainActivity extends AppCompatActivity {
    ...
    final int[] death_card_maker_rip_bgringarray_color = {R.color.color1, R.color.color2, R.color.color3, R.color.color4, R.color.color5, R.color.color6, R.color.color7, R.color.color8, R.color.color9, R.color.color10, R.color.color11, R.color.color12, R.color.color13, R.color.color14, R.color.color15, R.color.color16, R.color.color17, R.color.color18, R.color.color19, R.color.color20};
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.death_card_maker_rip_ttff1.setOnClickListener(new View.OnClickListener() { 
            ...
            public void onClick(View view) {
                Hindi_MainActivity.this.death_card_maker_rip_form1_detail_1();
            }
        });
        this.death_card_maker_rip_ttff2.setOnClickListener(new View.OnClickListener() { 
            @Override 
            public void onClick(View view) {
                Hindi_MainActivity.this.death_card_maker_rip_form2_detail_2();
            }
        });
        this.death_card_maker_rip_ttff3.setOnClickListener(new View.OnClickListener() { 
            @Override 
            public void onClick(View view) {
                Hindi_MainActivity.this.death_card_maker_rip_form3_detail_3();
            }
        });
        ...
        this.death_card_maker_rip_Ring.setOnClickListener(new View.OnClickListener() { 
            @Override 
            public void onClick(View view) {
                Hindi_MainActivity.this.death_card_maker_rip_ring_layout.setVisibility(View.VISIBLE);
            }
        });
        this.death_card_maker_rip_bgframe_color.setOnClickListener(new View.OnClickListener() { 
            @Override 
            public void onClick(View view) {
                Hindi_MainActivity.this.death_card_maker_rip_bgframe_colorlayout.setVisibility(View.VISIBLE);
            }
        });
        this.color.setOnClickListener(new View.OnClickListener() { 
            @Override 
            public void onClick(View view) {
                ColorPickerDialogBuilder.with(Hindi_MainActivity.this).setTitle(R.string.color_dialog_title).initialColor(Hindi_MainActivity.this.currentBackgroundColor).wheelType(ColorPickerView.WHEEL_TYPE.FLOWER).density(12).setOnColorChangedListener(new OnColorChangedListener() { 
                    @Override 
                    ...
                    public void onClick(DialogInterface dialogInterface, int i, Integer[] numArr) {
                        Hindi_MainActivity.this.death_card_maker_rip_framebg_img.setColorFilter(i);
                        if (numArr != null) {
                            ...
                            if (sb != null) {
                                Toast.makeText(Hindi_MainActivity.this.getApplicationContext(), sb.toString(), Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
                ...
                }).showColorEdit(true).setColorEditTextColor(ContextCompat.getColor(Hindi_MainActivity.this, android.R.color.holo_blue_bright)).build().show();
            }
        });
        this.death_card_maker_rip_bg_frame.setOnClickListener(new View.OnClickListener() { 
            @Override 
            public void onClick(View view) {
                Hindi_MainActivity.this.death_card_maker_rip_bg_layout.setVisibility(View.VISIBLE);
            }
        });
        this.death_card_maker_rip_bgframe_color.setOnClickListener(new View.OnClickListener() { 
            @Override 
        ...
        this.death_card_maker_rip_Divoclick.setOnClickListener(new View.OnClickListener() { 
            @Override 
            public void onClick(View view) {
                Hindi_MainActivity.this.death_card_maker_rip_diya_layout.setVisibility(View.VISIBLE);
            }
        });
        ...
        linearLayout.setOnClickListener(new View.OnClickListener() { 
            @Override 
            public void onClick(View view) {
                if (Hindi_MainActivity.death_card_maker_rip_click) {
                    Hindi_MainActivity.this.fontsizes();
                } else {
                    Toast.makeText(Hindi_MainActivity.this, "First now form submit then font size change", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        this.death_card_maker_rip_select_photo.setOnClickListener(new View.OnClickListener() { 
            @Override 
            public void onClick(View view) {
                Hindi_MainActivity.this.startActivityForResult(new Intent("android.intent.action.PICK", MediaStore.Images.Media.EXTERNAL_CONTENT_URI), Hindi_MainActivity.RESULT_LOAD_IMAGE);
            }
        });
        ...
        this.death_card_maker_rip_jjbg_gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() { 
            ...
            public void onItemClick(AdapterView adapterView, View view, int i6, long j) {
                Hindi_MainActivity.this.death_card_maker_rip_bgframe_colorlayout.setVisibility(View.GONE);
                Hindi_MainActivity.this.death_card_maker_rip_jjbg_img.setImageResource(Hindi_MainActivity.this.death_card_maker_rip_bgringarray_color[i6]);
            }
        });
        this.death_card_maker_rip_bg_gridview.setAdapter((ListAdapter) new ImageAdapter(getApplicationContext(), this.death_card_maker_rip_arrayListbg));
        ...
        this.death_card_maker_rip_design_frame.setOnClickListener(new View.OnClickListener() { 
            @Override 
            public void onClick(View view) {
                Hindi_MainActivity.this.death_card_maker_rip_design_layout.setVisibility(View.VISIBLE);
            }
        });
        ...
        this.death_card_maker_rip_design_gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() { 
            @Override 
            public void onItemClick(AdapterView adapterView, View view, int i6, long j) {
                Hindi_MainActivity.this.death_card_maker_rip_design_layout.setVisibility(View.GONE);
                Hindi_MainActivity.this.death_card_maker_rip_design_img.setImageResource(Hindi_MainActivity.this.death_card_maker_rip_dgringarray[i6]);
            }
        });
    }
    ...
    class AnonymousClass15 implements View.OnClickListener {
        ...
        @Override 
        public void onClick(View view) {
            Hindi_MainActivity.this.death_card_maker_rip_downloads();
            final Handler handler = new Handler() { 
                @Override 
                public void handleMessage(Message message) {
                    super.handleMessage(message);
                    Hindi_MainActivity.this.death_card_maker_rip_progressDialog.incrementProgressBy(10);
                }
            };
            Hindi_MainActivity.this.death_card_maker_rip_progressDialog = new ProgressDialog(Hindi_MainActivity.this);
            Hindi_MainActivity.this.death_card_maker_rip_progressDialog.setMax(100);
            Hindi_MainActivity.this.death_card_maker_rip_progressDialog.setMessage("Loading...");
            Hindi_MainActivity.this.death_card_maker_rip_progressDialog.setTitle("Image Save...");
            Hindi_MainActivity.this.death_card_maker_rip_progressDialog.setProgressStyle(1);
            Hindi_MainActivity.this.death_card_maker_rip_progressDialog.show();
            Hindi_MainActivity.this.death_card_maker_rip_progressDialog.setCancelable(false);
            new Thread(new Runnable() { 
                @Override 
                public void run() {
                    while (Hindi_MainActivity.this.death_card_maker_rip_progressDialog.getProgress() <= Hindi_MainActivity.this.death_card_maker_rip_progressDialog.getMax()) {
                        try {
                            Thread.sleep(200L);
                            Handler handler2 = handler;
                            handler2.sendMessage(handler2.obtainMessage());
                            if (Hindi_MainActivity.this.death_card_maker_rip_progressDialog.getProgress() == Hindi_MainActivity.this.death_card_maker_rip_progressDialog.getMax()) {
                                Hindi_MainActivity.this.death_card_maker_rip_progressDialog.dismiss();
                            }
                        } catch (Exception e) {
            ...
            new Handler().postDelayed(new Runnable() { 
                ...
                public void run() {
                        ...
                        Intent intent6 = new Intent(Hindi_MainActivity.this, Save_Image_Activity.class);
                        intent6.putExtra("img", Hindi_MainActivity.this.death_card_maker_rip_name);
                        Hindi_MainActivity.this.startActivity(intent6);
    ...
    class AnonymousClass20 implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView adapterView, View view, final int i, long j) {
                ...
                Hindi_MainActivity.this.death_card_maker_rip_diya_layout.setVisibility(View.GONE);
                Hindi_MainActivity.this.death_card_maker_rip_maindiya0.setImageResource(Hindi_MainActivity.this.death_card_maker_rip_divaarray[i]);
                Hindi_MainActivity.this.death_card_maker_rip_maindiya1.setImageResource(Hindi_MainActivity.this.death_card_maker_rip_divaarray[i]);
    ...
    class AnonymousClass21 implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView adapterView, View view, final int i, long j) {
                ...
                Hindi_MainActivity.this.death_card_maker_rip_ring_layout.setVisibility(View.GONE);
                Hindi_MainActivity.this.death_card_maker_rip_ring_img.setImageResource(Hindi_MainActivity.this.death_card_maker_rip_ringarray[i]);
    ...
    class AnonymousClass22 implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView adapterView, View view, final int i, long j) {
                ...
                Hindi_MainActivity.this.death_card_maker_rip_bg_layout.setVisibility(View.GONE);
                Hindi_MainActivity.this.death_card_maker_rip_framebg_img.setImageResource(Hindi_MainActivity.this.death_card_maker_rip_framearray[i]);
    ...
    public void fontsizes() {
        ...
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { 
            ...
            public void onStopTrackingTouch(SeekBar seekBar2) {
                Hindi_MainActivity _Hindi_MainActivity = Hindi_MainActivity.this;
                _Hindi_MainActivity.death_card_maker_rip_prefs = _Hindi_MainActivity.getPreferences(0);
                SharedPreferences.Editor edit = Hindi_MainActivity.this.death_card_maker_rip_prefs.edit();
                edit.putFloat("fontsize", Hindi_MainActivity.this.death_card_maker_rip_Maintext.getTextSize());
                edit.commit();
            }
            ...
            public void onProgressChanged(SeekBar seekBar2, int i, boolean z) {
                float f = i;
                Hindi_MainActivity.this.death_card_maker_rip_Maintext.setTextSize(f);
                Hindi_MainActivity.this.death_card_maker_rip_click_besnu.setTextSize(f);
                Hindi_MainActivity.this.death_card_maker_rip_detaillset.setTextSize(f);
                Hindi_MainActivity.this.death_card_maker_rip_setname1.setTextSize(f);
                Hindi_MainActivity.this.death_card_maker_rip_setname2.setTextSize(f);
                Hindi_MainActivity.this.death_card_maker_rip_setname3.setTextSize(f);
                Hindi_MainActivity.this.death_card_maker_rip_setname4.setTextSize(f);
                Hindi_MainActivity.this.death_card_maker_rip_setname5.setTextSize(f);
                Hindi_MainActivity.this.death_card_maker_rip_setnumber1.setTextSize(f);
                Hindi_MainActivity.this.death_card_maker_rip_setnumber2.setTextSize(f);
                Hindi_MainActivity.this.death_card_maker_rip_setnumber3.setTextSize(f);
                Hindi_MainActivity.this.death_card_maker_rip_setnumber4.setTextSize(f);
                Hindi_MainActivity.this.death_card_maker_rip_setnumber5.setTextSize(f);
            }
        });
    ...
    public void death_card_maker_rip_form1_detail_1() {
        ...
        ((TextView) inflate.findViewById(R.id.mset_btn)).setOnClickListener(new View.OnClickListener() { 
            ...
            public void onClick(View view) {
                if (editText.getText().toString().isEmpty()) {
                    ...
                    Hindi_MainActivity.this.death_card_maker_rip_detail_form1.setVisibility(View.GONE);
                    Hindi_MainActivity.this.death_card_maker_rip_Maintext.setText("अत्यंत दुःख के साथ सूचित करना पड रहा है की गांव " + editText.getText().toString() + " निवासी हमारे " + editText2.getText().toString() + MaskedEditText.SPACE + editText3.getText().toString() + " (उ. व." + editText4.getText().toString() + ") ता." + maskedEditText.getText().toString() + MaskedEditText.SPACE + textView.getText().toString() + " के रोज स्वर्गवास हुए है | परमात्मा उनकी आत्मा को शांति दे यही ईश्वर से प्रार्थना |  ");
                    Hindi_MainActivity.death_card_maker_rip_click = true;
                    Hindi_MainActivity.this.death_card_maker_rip_nameofdeath.setText(editText3.getText().toString());
                    Hindi_MainActivity.this.death_card_maker_rip_nameofdeath.setTextColor(Hindi_MainActivity.this.getResources().getColor(R.color.black));
                    create.dismiss();
                }
            }
        });
        textView.setOnClickListener(new View.OnClickListener() { 
            @Override 
            public void onClick(View view) {
                View inflate2 = LayoutInflater.from(Hindi_MainActivity.this).inflate(R.layout.hindi_war_list, (ViewGroup) null);
                final AlertDialog create2 = new AlertDialog.Builder(Hindi_MainActivity.this).create();
                ...
                inflate2.findViewById(R.id.v2).setOnClickListener(new View.OnClickListener() { 
                    @Override 
                    public void onClick(View view2) {
                        textView.setText(R.string.var2);
                        create2.dismiss();
                    }
                });
                inflate2.findViewById(R.id.v3).setOnClickListener(new View.OnClickListener() { 
                    @Override 
                    public void onClick(View view2) {
                        textView.setText(R.string.var3);
                        create2.dismiss();
                    }
                });
                inflate2.findViewById(R.id.v4).setOnClickListener(new View.OnClickListener() { 
                    @Override 
                    public void onClick(View view2) {
                        textView.setText(R.string.var4);
                        create2.dismiss();
                    }
                });
                inflate2.findViewById(R.id.v5).setOnClickListener(new View.OnClickListener() { 
                    @Override 
                    public void onClick(View view2) {
                        textView.setText(R.string.var5);
                        create2.dismiss();
                    }
                });
                inflate2.findViewById(R.id.v6).setOnClickListener(new View.OnClickListener() { 
                    @Override 
                    public void onClick(View view2) {
                        textView.setText(R.string.var6);
                        create2.dismiss();
                    }
                });
                inflate2.findViewById(R.id.v7).setOnClickListener(new View.OnClickListener() { 
                    @Override 
                    public void onClick(View view2) {
                        textView.setText(R.string.var7);
                        create2.dismiss();
                    }
                });
    ...
    public void death_card_maker_rip_form2_detail_2() {
        ...
        textView.setOnClickListener(new View.OnClickListener() { 
            ...
            public void onClick(View view) {
                if (maskedEditText.getText().toString().isEmpty()) {
                    ...
                    Hindi_MainActivity.this.death_card_maker_rip_detail_form2.setVisibility(View.GONE);
                    if (Hindi_MainActivity.this.death_card_maker_rip_counter != 0) {
                        TextView textView6 = Hindi_MainActivity.this.death_card_maker_rip_detaillset;
                        Hindi_MainActivity.this.death_card_maker_rip_click_besnu.setText("दिनांक " + maskedEditText.getText().toString() + MaskedEditText.SPACE + textView4.getText().toString() + " के रोज " + textView5.getText().toString() + MaskedEditText.SPACE + editText2.getText().toString() + "  बजे से  " + editText3.getText().toString() + "  बजे तक रखा हुआ है ");
                        textView6.setText("सरनामा  " + editText.getText().toString());
                        Hindi_MainActivity.death_card_maker_rip_click = true;
                    } else {
                        Hindi_MainActivity.this.death_card_maker_rip_click_besnu.setText("दिनांक : " + maskedEditText.getText().toString() + MaskedEditText.SPACE + textView4.getText().toString() + " के रोज " + textView5.getText().toString() + MaskedEditText.SPACE + editText2.getText().toString() + " बजे से  " + editText3.getText().toString() + " बजे तक फोन पर पूछने की व्यवस्था है।");
                        Hindi_MainActivity.death_card_maker_rip_click = true;
                    }
                    create.dismiss();
                }
        ...
        editText3.setOnClickListener(new View.OnClickListener() { 
            ...
            public void onClick(View view) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(Hindi_MainActivity.this, new TimePickerDialog.OnTimeSetListener() { 
                    @Override 
        ...
        textView4.setOnClickListener(new View.OnClickListener() { 
            ...
            public void onClick(View view) {
                ...
                inflate2.findViewById(R.id.v1).setOnClickListener(new View.OnClickListener() { 
                    @Override 
                    public void onClick(View view2) {
                        textView4.setText(R.string.var1);
                        create2.dismiss();
                    }
                });
                inflate2.findViewById(R.id.v2).setOnClickListener(new View.OnClickListener() { 
                    @Override 
                    public void onClick(View view2) {
                        textView4.setText(R.string.var2);
                        create2.dismiss();
                    }
                });
                inflate2.findViewById(R.id.v3).setOnClickListener(new View.OnClickListener() { 
                    @Override 
                    public void onClick(View view2) {
                        textView4.setText(R.string.var3);
                        create2.dismiss();
                    }
                });
                inflate2.findViewById(R.id.v4).setOnClickListener(new View.OnClickListener() { 
                    @Override 
                    public void onClick(View view2) {
                        textView4.setText(R.string.var4);
                        create2.dismiss();
                    }
                });
                inflate2.findViewById(R.id.v5).setOnClickListener(new View.OnClickListener() { 
                    @Override 
                    public void onClick(View view2) {
                        textView4.setText(R.string.var5);
                        create2.dismiss();
                    }
                });
                inflate2.findViewById(R.id.v6).setOnClickListener(new View.OnClickListener() { 
                    @Override 
                    public void onClick(View view2) {
                        textView4.setText(R.string.var6);
                        create2.dismiss();
                    }
                });
                inflate2.findViewById(R.id.v7).setOnClickListener(new View.OnClickListener() { 
                    @Override 
                    public void onClick(View view2) {
                        textView4.setText(R.string.var7);
                        create2.dismiss();
                    }
                });
                inflate2.findViewById(R.id.close).setOnClickListener(new View.OnClickListener() { 
        ...
        textView5.setOnClickListener(new View.OnClickListener() { 
            @Override 
            public void onClick(View view) {
                View inflate2 = LayoutInflater.from(Hindi_MainActivity.this).inflate(R.layout.hindi_smay_list, (ViewGroup) null);
                final AlertDialog create2 = new AlertDialog.Builder(Hindi_MainActivity.this).create();
                inflate2.findViewById(R.id.v1).setOnClickListener(new View.OnClickListener() { 
                    @Override 
                    public void onClick(View view2) {
                        textView5.setText(R.string.sanj1);
                        create2.dismiss();
                    }
                });
                inflate2.findViewById(R.id.v2).setOnClickListener(new View.OnClickListener() { 
                    @Override 
                    public void onClick(View view2) {
                        textView5.setText(R.string.svar1);
                        create2.dismiss();
                    }
                });
                inflate2.findViewById(R.id.v3).setOnClickListener(new View.OnClickListener() { 
                    @Override 
                    public void onClick(View view2) {
                        textView5.setText(R.string.bpore1);
                        create2.dismiss();
                    }
                });
                inflate2.findViewById(R.id.close).setOnClickListener(new View.OnClickListener() { 
        ...
        textView2.setOnClickListener(new View.OnClickListener() { 
            @Override 
            public void onClick(View view) {
                Hindi_MainActivity.this.death_card_maker_rip_counter = 0;
        ...
        textView3.setOnClickListener(new View.OnClickListener() { 
            @Override 
            public void onClick(View view) {
                Toast.makeText(Hindi_MainActivity.this, "निवास की जगह", Toast.LENGTH_SHORT).show();
                Hindi_MainActivity.this.death_card_maker_rip_counter = 1;
    ...
    public void death_card_maker_rip_form3_detail_3() {
        View inflate = LayoutInflater.from(this).inflate(R.layout.hindi_form3, (ViewGroup) null);
        final AlertDialog create = new AlertDialog.Builder(this, R.style.myFullscreenAlertDialogStyle).create();
        ...
        ((TextView) inflate.findViewById(R.id.mset_btn)).setOnClickListener(new View.OnClickListener() { 
            @Override 
            public void onClick(View view) {
                Hindi_MainActivity.this.death_card_maker_rip_detail_form3.setVisibility(View.VISIBLE);
                Hindi_MainActivity.this.death_card_maker_rip_form3Gone.setVisibility(View.GONE);
                if (textView.getText().toString().isEmpty()) {
                    textView.setError("");
                    textView.requestFocus();
                } else if (!textView2.getText().toString().isEmpty()) {
                    Hindi_MainActivity.this.death_card_maker_rip_setname1.setTextColor(Hindi_MainActivity.this.getResources().getColor(R.color.black));
                    Hindi_MainActivity.this.death_card_maker_rip_setname1.setText(textView.getText().toString());
                    Hindi_MainActivity.this.death_card_maker_rip_setname2.setTextColor(Hindi_MainActivity.this.getResources().getColor(R.color.black));
                    Hindi_MainActivity.this.death_card_maker_rip_setname2.setText(textView3.getText().toString());
                    Hindi_MainActivity.this.death_card_maker_rip_setname3.setTextColor(Hindi_MainActivity.this.getResources().getColor(R.color.black));
                    Hindi_MainActivity.this.death_card_maker_rip_setname3.setText(textView5.getText().toString());
                    Hindi_MainActivity.this.death_card_maker_rip_setname4.setTextColor(Hindi_MainActivity.this.getResources().getColor(R.color.black));
                    Hindi_MainActivity.this.death_card_maker_rip_setname4.setText(textView7.getText().toString());
                    Hindi_MainActivity.this.death_card_maker_rip_setname5.setTextColor(Hindi_MainActivity.this.getResources().getColor(R.color.black));
                    Hindi_MainActivity.this.death_card_maker_rip_setname5.setText(textView9.getText().toString());
                    Hindi_MainActivity.this.death_card_maker_rip_setnumber1.setTextColor(Hindi_MainActivity.this.getResources().getColor(R.color.black));
                    Hindi_MainActivity.this.death_card_maker_rip_setnumber1.setText(textView2.getText().toString());
                    Hindi_MainActivity.this.death_card_maker_rip_setnumber2.setTextColor(Hindi_MainActivity.this.getResources().getColor(R.color.black));
                    Hindi_MainActivity.this.death_card_maker_rip_setnumber2.setText(textView4.getText().toString());
                    Hindi_MainActivity.this.death_card_maker_rip_setnumber3.setTextColor(Hindi_MainActivity.this.getResources().getColor(R.color.black));
                    Hindi_MainActivity.this.death_card_maker_rip_setnumber3.setText(textView6.getText().toString());
                    Hindi_MainActivity.this.death_card_maker_rip_setnumber4.setTextColor(Hindi_MainActivity.this.getResources().getColor(R.color.black));
                    Hindi_MainActivity.this.death_card_maker_rip_setnumber4.setText(textView8.getText().toString());
                    Hindi_MainActivity.this.death_card_maker_rip_setnumber5.setTextColor(Hindi_MainActivity.this.getResources().getColor(R.color.black));
                    Hindi_MainActivity.this.death_card_maker_rip_setnumber5.setText(textView10.getText().toString());
                    Hindi_MainActivity.death_card_maker_rip_click = true;
                    create.dismiss();
                } else {
                    textView2.setError("");
    ...
    public void onBackPressed() {
        if (this.death_card_maker_rip_bg_layout.getVisibility() == View.VISIBLE) {
            ...
            View inflate = getLayoutInflater().inflate(R.layout.hindi_exit_dialog, (ViewGroup) null, false);
            ...
            ((CardView) dialog.findViewById(R.id.tv_dialog_yes_sure)).setOnClickListener(new View.OnClickListener() { 
                @Override 
                public void onClick(View view) {
                    Hindi_MainActivity.super.onBackPressed();
                }
            });
