...
public class English_MainActivity extends AppCompatActivity {
    ...
    private static int death_card_maker_rip_RESULT_LOAD_IMAGE = 1;
    ...
    TextView death_card_maker_rip_mset_btn;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.english_main_activity);
        ...
        linearLayout.setOnClickListener(new View.OnClickListener() { 
            ...
            public void onClick(View view) {
                if (English_MainActivity.death_card_maker_rip_click) {
                    English_MainActivity.this.death_card_maker_rip_fontsizes();
                } else {
                    Toast.makeText(English_MainActivity.this, "First now form submit then font size change", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        this.death_card_maker_rip_form1.setOnClickListener(new View.OnClickListener() { 
            @Override 
            public void onClick(View view) {
                English_MainActivity.this.death_card_maker_rip_form1_detail_1();
            }
        });
        ...
        this.death_card_maker_rip_form2.setOnClickListener(new View.OnClickListener() { 
            @Override 
            public void onClick(View view) {
                English_MainActivity.this.death_card_maker_rip_form2_detail_2();
            }
        });
        this.death_card_maker_rip_form3.setOnClickListener(new View.OnClickListener() { 
            @Override 
            public void onClick(View view) {
                English_MainActivity.this.death_card_maker_rip_form3_detail_3();
            }
        });
        ...
        this.death_card_maker_rip_Ring.setOnClickListener(new View.OnClickListener() { 
            @Override 
            public void onClick(View view) {
                English_MainActivity.this.death_card_maker_rip_ring_layout.setVisibility(View.VISIBLE);
            }
        });
        this.death_card_maker_rip_bgframe_color.setOnClickListener(new View.OnClickListener() { 
            @Override 
            public void onClick(View view) {
                English_MainActivity.this.death_card_maker_rip_bgframe_colorlayout.setVisibility(View.VISIBLE);
            }
        });
        this.death_card_maker_rip_color.setOnClickListener(new View.OnClickListener() { 
            @Override 
            public void onClick(View view) {
                ColorPickerDialogBuilder.with(English_MainActivity.this).setTitle(R.string.color_dialog_title).initialColor(English_MainActivity.this.death_card_maker_rip_currentBackgroundColor).wheelType(ColorPickerView.WHEEL_TYPE.FLOWER).density(12).setOnColorChangedListener(new OnColorChangedListener() { 
                    @Override 
                    ...
                    public void onClick(DialogInterface dialogInterface, int i, Integer[] numArr) {
                        English_MainActivity.this.death_card_maker_rip_framebg_img.setColorFilter(i);
                        if (numArr != null) {
                            ...
                            if (sb != null) {
                                Toast.makeText(English_MainActivity.this.getApplicationContext(), sb.toString(), Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
                ...
                }).showColorEdit(true).setColorEditTextColor(ContextCompat.getColor(English_MainActivity.this, android.R.color.holo_blue_bright)).build().show();
            }
        });
        this.death_card_maker_rip_bg_frame.setOnClickListener(new View.OnClickListener() { 
            @Override 
            public void onClick(View view) {
                English_MainActivity.this.death_card_maker_rip_bg_layout.setVisibility(View.VISIBLE);
            }
        });
        this.death_card_maker_rip_bgframe_color.setOnClickListener(new View.OnClickListener() { 
            @Override 
        ...
        this.death_card_maker_rip_Divoclick.setOnClickListener(new View.OnClickListener() { 
            @Override 
            public void onClick(View view) {
                English_MainActivity.this.death_card_maker_rip_diya_layout.setVisibility(View.VISIBLE);
            }
        });
        ...
        this.death_card_maker_rip_select_photo.setOnClickListener(new View.OnClickListener() { 
            @Override 
            public void onClick(View view) {
                English_MainActivity.this.startActivityForResult(new Intent("android.intent.action.PICK", MediaStore.Images.Media.EXTERNAL_CONTENT_URI), English_MainActivity.death_card_maker_rip_RESULT_LOAD_IMAGE);
            }
        });
        ...
        this.death_card_maker_rip_jjbg_gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() { 
            ...
            public void onItemClick(AdapterView adapterView, View view, int i6, long j) {
                English_MainActivity.this.death_card_maker_rip_bgframe_colorlayout.setVisibility(View.GONE);
                English_MainActivity.this.death_card_maker_rip_jjbg_img.setImageResource(English_MainActivity.this.death_card_maker_rip_bgringarray_color[i6]);
            }
        });
        this.death_card_maker_rip_bg_gridview.setAdapter((ListAdapter) new ImageAdapter(getApplicationContext(), this.death_card_maker_rip_arrayListbg));
        ...
        this.death_card_maker_rip_design_frame.setOnClickListener(new View.OnClickListener() { 
            @Override 
            public void onClick(View view) {
                English_MainActivity.this.death_card_maker_rip_design_layout.setVisibility(View.VISIBLE);
            }
        });
        ...
        this.death_card_maker_rip_design_gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() { 
            @Override 
            public void onItemClick(AdapterView adapterView, View view, int i6, long j) {
                English_MainActivity.this.death_card_maker_rip_design_layout.setVisibility(View.GONE);
                English_MainActivity.this.death_card_maker_rip_design_img.setImageResource(English_MainActivity.this.death_card_maker_rip_dgringarray[i6]);
            }
        });
    }
    ...
    class AnonymousClass15 implements View.OnClickListener {
        ...
        @Override 
        public void onClick(View view) {
            English_MainActivity.this.death_card_maker_rip_downloads();
            final Handler handler = new Handler() { 
                @Override 
                public void handleMessage(Message message) {
                    super.handleMessage(message);
                    English_MainActivity.this.death_card_maker_rip_progressDialog.incrementProgressBy(10);
                }
            };
            English_MainActivity.this.death_card_maker_rip_progressDialog = new ProgressDialog(English_MainActivity.this);
            English_MainActivity.this.death_card_maker_rip_progressDialog.setMax(100);
            English_MainActivity.this.death_card_maker_rip_progressDialog.setMessage("Loading...");
            English_MainActivity.this.death_card_maker_rip_progressDialog.setTitle("Image Save...");
            English_MainActivity.this.death_card_maker_rip_progressDialog.setProgressStyle(1);
            English_MainActivity.this.death_card_maker_rip_progressDialog.show();
            English_MainActivity.this.death_card_maker_rip_progressDialog.setCancelable(false);
            new Thread(new Runnable() { 
                @Override 
                public void run() {
                    while (English_MainActivity.this.death_card_maker_rip_progressDialog.getProgress() <= English_MainActivity.this.death_card_maker_rip_progressDialog.getMax()) {
                        try {
                            Thread.sleep(200L);
                            Handler handler2 = handler;
                            handler2.sendMessage(handler2.obtainMessage());
                            if (English_MainActivity.this.death_card_maker_rip_progressDialog.getProgress() == English_MainActivity.this.death_card_maker_rip_progressDialog.getMax()) {
                                English_MainActivity.this.death_card_maker_rip_progressDialog.dismiss();
                            }
                        } catch (Exception e) {
                            e.printStackTrace();
                            return;
            ...
            new Handler().postDelayed(new Runnable() { 
                ...
                public void run() {
                        ...
                        Intent intent6 = new Intent(English_MainActivity.this, Save_Image_Activity.class);
                        intent6.putExtra("img", English_MainActivity.this.death_card_maker_rip_name);
                        English_MainActivity.this.startActivity(intent6);
    ...
    class AnonymousClass20 implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView adapterView, View view, final int i, long j) {
                ...
                English_MainActivity.this.death_card_maker_rip_diya_layout.setVisibility(View.GONE);
                English_MainActivity.this.death_card_maker_rip_maindiya0.setImageResource(English_MainActivity.this.death_card_maker_rip_divaarray[i]);
                English_MainActivity.this.death_card_maker_rip_maindiya1.setImageResource(English_MainActivity.this.death_card_maker_rip_divaarray[i]);
    ...
    class AnonymousClass21 implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView adapterView, View view, final int i, long j) {
                ...
                English_MainActivity.this.death_card_maker_rip_ring_layout.setVisibility(View.GONE);
                English_MainActivity.this.death_card_maker_rip_ring_img.setImageResource(English_MainActivity.this.death_card_maker_rip_ringarray[i]);
    ...
    class AnonymousClass22 implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView adapterView, View view, final int i, long j) {
                ...
                English_MainActivity.this.death_card_maker_rip_bg_layout.setVisibility(View.GONE);
                English_MainActivity.this.death_card_maker_rip_framebg_img.setImageResource(English_MainActivity.this.death_card_maker_rip_framearray[i]);
    ...
    public void death_card_maker_rip_fontsizes() {
        ...
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { 
            ...
            public void onStopTrackingTouch(SeekBar seekBar2) {
                English_MainActivity _English_MainActivity = English_MainActivity.this;
                _English_MainActivity.death_card_maker_rip_prefs = _English_MainActivity.getPreferences(0);
                SharedPreferences.Editor edit = English_MainActivity.this.death_card_maker_rip_prefs.edit();
                edit.putFloat("fontsize", English_MainActivity.this.death_card_maker_rip_Maintext.getTextSize());
                edit.commit();
            }
            ...
            public void onProgressChanged(SeekBar seekBar2, int i, boolean z) {
                float f = i;
                English_MainActivity.this.death_card_maker_rip_Maintext.setTextSize(f);
                English_MainActivity.this.death_card_maker_rip_click_besnu.setTextSize(f);
                English_MainActivity.this.death_card_maker_rip_detaillset.setTextSize(f);
                English_MainActivity.this.death_card_maker_rip_setname1.setTextSize(f);
                English_MainActivity.this.death_card_maker_rip_setname2.setTextSize(f);
                English_MainActivity.this.death_card_maker_rip_setname3.setTextSize(f);
                English_MainActivity.this.death_card_maker_rip_setname4.setTextSize(f);
                English_MainActivity.this.death_card_maker_rip_setname5.setTextSize(f);
                English_MainActivity.this.death_card_maker_rip_setnumber1.setTextSize(f);
                English_MainActivity.this.death_card_maker_rip_setnumber2.setTextSize(f);
                English_MainActivity.this.death_card_maker_rip_setnumber3.setTextSize(f);
                English_MainActivity.this.death_card_maker_rip_setnumber4.setTextSize(f);
                English_MainActivity.this.death_card_maker_rip_setnumber5.setTextSize(f);
            }
        });
    ...
    public void death_card_maker_rip_form1_detail_1() {
        ...
        TextView textView2 = (TextView) inflate.findViewById(R.id.mset_btn);
        this.death_card_maker_rip_mset_btn = textView2;
        textView2.setOnClickListener(new View.OnClickListener() { 
            ...
            public void onClick(View view) {
                if (editText.getText().toString().isEmpty()) {
                    ...
                    English_MainActivity.this.death_card_maker_rip_detail_form1.setVisibility(View.GONE);
                    English_MainActivity.this.death_card_maker_rip_Maintext.setText("With Sorrow We inform the sad Demise of Town " + editText.getText().toString() + " Resident ours " + editText2.getText().toString() + MaskedEditText.SPACE + editText3.getText().toString() + " (Age." + editText4.getText().toString() + ") Died on Date." + maskedEditText.getText().toString() + MaskedEditText.SPACE + textView.getText().toString() + " May the almighty God rest his soul in peace. ");
                    English_MainActivity.this.death_card_maker_rip_nameofdeath.setText(editText3.getText().toString());
                    English_MainActivity.this.death_card_maker_rip_nameofdeath.setTextColor(English_MainActivity.this.getResources().getColor(R.color.black));
                    English_MainActivity.death_card_maker_rip_click = true;
                    create.dismiss();
                }
            }
        });
        textView.setOnClickListener(new View.OnClickListener() { 
            @Override 
            public void onClick(View view) {
                View inflate2 = LayoutInflater.from(English_MainActivity.this).inflate(R.layout.english_war_list, (ViewGroup) null);
                final AlertDialog create2 = new AlertDialog.Builder(English_MainActivity.this).create();
                inflate2.findViewById(R.id.v1).setOnClickListener(new View.OnClickListener() { 
                    @Override 
                    public void onClick(View view2) {
                        textView.setText(R.string.var15);
                        create2.dismiss();
                    }
                });
                inflate2.findViewById(R.id.v2).setOnClickListener(new View.OnClickListener() { 
                    @Override 
                    public void onClick(View view2) {
                        textView.setText(R.string.var16);
                        create2.dismiss();
                    }
                });
                inflate2.findViewById(R.id.v3).setOnClickListener(new View.OnClickListener() { 
                    @Override 
                    public void onClick(View view2) {
                        textView.setText(R.string.var17);
                        create2.dismiss();
                    }
                });
                inflate2.findViewById(R.id.v4).setOnClickListener(new View.OnClickListener() { 
                    @Override 
                    public void onClick(View view2) {
                        textView.setText(R.string.var18);
                        create2.dismiss();
                    }
                });
                inflate2.findViewById(R.id.v5).setOnClickListener(new View.OnClickListener() { 
                    @Override 
                    public void onClick(View view2) {
                        textView.setText(R.string.var19);
                        create2.dismiss();
                    }
                });
                inflate2.findViewById(R.id.v6).setOnClickListener(new View.OnClickListener() { 
                    @Override 
                    public void onClick(View view2) {
                        textView.setText(R.string.var20);
                        create2.dismiss();
                    }
                });
                inflate2.findViewById(R.id.v7).setOnClickListener(new View.OnClickListener() { 
                    @Override 
                    public void onClick(View view2) {
                        textView.setText(R.string.var21);
                        create2.dismiss();
                    }
                });
    ...
    public void death_card_maker_rip_form2_detail_2() {
        ...
        final TextView textView2 = (TextView) inflate.findViewById(R.id.time1);
        final TextView textView3 = (TextView) inflate.findViewById(R.id.time2);
        TextView textView4 = (TextView) inflate.findViewById(R.id.place_addrese);
        final TextView textView5 = (TextView) inflate.findViewById(R.id.tele);
        final TextView textView6 = (TextView) inflate.findViewById(R.id.nivas);
        final MaskedEditText maskedEditText = (MaskedEditText) inflate.findViewById(R.id.set_date);
        final TextView textView7 = (TextView) inflate.findViewById(R.id.var_select);
        final TextView textView8 = (TextView) inflate.findViewById(R.id.time_select);
        ...
        textView.setOnClickListener(new View.OnClickListener() { 
            ...
            public void onClick(View view) {
                if (maskedEditText.getText().toString().isEmpty()) {
                ...
                } else if (textView8.getText().toString().isEmpty()) {
                    textView8.setError("");
                    ...
                    English_MainActivity.this.death_card_maker_rip_detail_form2.setVisibility(View.GONE);
                    if (English_MainActivity.this.death_card_maker_rip_counter != 0) {
                        TextView textView9 = English_MainActivity.this.death_card_maker_rip_click_besnu;
                        TextView textView10 = English_MainActivity.this.death_card_maker_rip_detaillset;
                        textView9.setText("The Squat is Date " + maskedEditText.getText().toString() + " on " + textView7.getText().toString() + " Kept From  " + textView2.getText().toString() + " In The0 " + textView8.getText().toString() + MaskedEditText.SPACE + textView3.getText().toString());
                        textView10.setText("Address : " + editText.getText().toString());
                        English_MainActivity.death_card_maker_rip_click = true;
                    } else {
                        English_MainActivity.this.death_card_maker_rip_click_besnu.setText("The Squat is Date " + maskedEditText.getText().toString() + " on " + textView7.getText().toString() + " Kept From " + textView2.getText().toString() + " In The " + textView8.getText().toString() + MaskedEditText.SPACE + textView3.getText().toString() + "  From Telephone");
                        English_MainActivity.death_card_maker_rip_click = true;
                    }
                    create.dismiss();
                }
        ...
        textView2.setOnClickListener(new View.OnClickListener() { 
            ...
            public void onClick(View view) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(English_MainActivity.this, new TimePickerDialog.OnTimeSetListener() { 
                    @Override 
                    public void onTimeSet(TimePicker timePicker, int i, int i2) {
                        ...
                        if (i == 0) {
                            ...
                            textView2.setText(i + ":" + valueOf + " PM");
                        }
                        textView2.setText(i + ":" + valueOf + " AM");
                    }
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(English_MainActivity.this, new TimePickerDialog.OnTimeSetListener() { 
                    ...
                    public void onTimeSet(TimePicker timePicker, int i, int i2) {
                        ...
                        if (i == 0) {
                            ...
                            textView3.setText(i + ":" + valueOf + " PM");
                        }
                        textView3.setText(i + ":" + valueOf + " AM");
                    }
                }, calendar.get(11), calendar.get(12), false);
                timePickerDialog.setTitle("Select Time");
                timePickerDialog.show();
        ...
        textView7.setOnClickListener(new View.OnClickListener() { 
            ...
            public void onClick(View view) {
                ...
                inflate2.findViewById(R.id.v1).setOnClickListener(new View.OnClickListener() { 
                    @Override 
                    public void onClick(View view2) {
                        textView7.setText(R.string.var15);
                        create2.dismiss();
                    }
                });
                inflate2.findViewById(R.id.v2).setOnClickListener(new View.OnClickListener() { 
                    @Override 
                    public void onClick(View view2) {
                        textView7.setText(R.string.var16);
                        create2.dismiss();
                    }
                });
                inflate2.findViewById(R.id.v3).setOnClickListener(new View.OnClickListener() { 
                    @Override 
                    public void onClick(View view2) {
                        textView7.setText(R.string.var17);
                        create2.dismiss();
                    }
                });
                inflate2.findViewById(R.id.v4).setOnClickListener(new View.OnClickListener() { 
                    @Override 
                    public void onClick(View view2) {
                        textView7.setText(R.string.var18);
                        create2.dismiss();
                    }
                });
                inflate2.findViewById(R.id.v5).setOnClickListener(new View.OnClickListener() { 
                    @Override 
                    public void onClick(View view2) {
                        textView7.setText(R.string.var19);
                        create2.dismiss();
                    }
                });
                inflate2.findViewById(R.id.v6).setOnClickListener(new View.OnClickListener() { 
                    @Override 
                    public void onClick(View view2) {
                        textView7.setText(R.string.var20);
                        create2.dismiss();
                    }
                });
                inflate2.findViewById(R.id.v7).setOnClickListener(new View.OnClickListener() { 
                    @Override 
                    public void onClick(View view2) {
                        textView7.setText(R.string.var21);
                        create2.dismiss();
                    }
                });
                inflate2.findViewById(R.id.close).setOnClickListener(new View.OnClickListener() { 
        ...
        textView8.setOnClickListener(new View.OnClickListener() { 
            @Override 
            public void onClick(View view) {
                View inflate2 = LayoutInflater.from(English_MainActivity.this).inflate(R.layout.english_smay_list, (ViewGroup) null);
                final AlertDialog create2 = new AlertDialog.Builder(English_MainActivity.this).create();
                inflate2.findViewById(R.id.v1).setOnClickListener(new View.OnClickListener() { 
                    @Override 
                    public void onClick(View view2) {
                        textView8.setText(R.string.sanj2);
                        create2.dismiss();
                    }
                });
                inflate2.findViewById(R.id.v2).setOnClickListener(new View.OnClickListener() { 
                    @Override 
                    public void onClick(View view2) {
                        textView8.setText(R.string.svar2);
                        create2.dismiss();
                    }
                });
                inflate2.findViewById(R.id.v3).setOnClickListener(new View.OnClickListener() { 
                    @Override 
                    public void onClick(View view2) {
                        textView8.setText(R.string.bpore2);
                        create2.dismiss();
                    }
                });
                inflate2.findViewById(R.id.close).setOnClickListener(new View.OnClickListener() { 
        ...
        textView5.setOnClickListener(new View.OnClickListener() { 
            @Override 
            public void onClick(View view) {
                English_MainActivity.this.death_card_maker_rip_counter = 0;
                textView5.setBackgroundResource(R.drawable.death_card_rip_post_fill_cir);
                textView6.setBackgroundResource(R.color.transparent);
                textView5.setTextColor(-1);
                linearLayout.setVisibility(View.GONE);
                Toast.makeText(English_MainActivity.this, "Condolence Meeting Form Telephone", Toast.LENGTH_SHORT).show();
        ...
        textView6.setOnClickListener(new View.OnClickListener() { 
            @Override 
            public void onClick(View view) {
                English_MainActivity.this.death_card_maker_rip_counter = 1;
                textView5.setTextColor(-7829368);
                textView6.setTextColor(-1);
                textView6.setBackgroundResource(R.drawable.death_card_rip_post_fill_cir);
    ...
    public void death_card_maker_rip_form3_detail_3() {
        this.death_card_maker_rip_sharedpreferences = getSharedPreferences("MyPrefs", 0);
        View inflate = LayoutInflater.from(this).inflate(R.layout.english_form3, (ViewGroup) null);
        final AlertDialog create = new AlertDialog.Builder(this, R.style.myFullscreenAlertDialogStyle).create();
        ...
        ((TextView) inflate.findViewById(R.id.mset_btn)).setOnClickListener(new View.OnClickListener() { 
            @Override 
            public void onClick(View view) {
                English_MainActivity.this.death_card_maker_rip_detail_form3.setVisibility(View.VISIBLE);
                English_MainActivity.this.death_card_maker_rip_form3Gone.setVisibility(View.GONE);
                if (textView.getText().toString().isEmpty()) {
                    textView.setError("");
                    textView.requestFocus();
                } else if (!textView2.getText().toString().isEmpty()) {
                    English_MainActivity.this.death_card_maker_rip_setname1.setTextColor(English_MainActivity.this.getResources().getColor(R.color.black));
                    English_MainActivity.this.death_card_maker_rip_setname1.setText(textView.getText().toString());
                    English_MainActivity.this.death_card_maker_rip_setname2.setTextColor(English_MainActivity.this.getResources().getColor(R.color.black));
                    English_MainActivity.this.death_card_maker_rip_setname2.setText(textView3.getText().toString());
                    English_MainActivity.this.death_card_maker_rip_setname3.setTextColor(English_MainActivity.this.getResources().getColor(R.color.black));
                    English_MainActivity.this.death_card_maker_rip_setname3.setText(textView5.getText().toString());
                    English_MainActivity.this.death_card_maker_rip_setname4.setTextColor(English_MainActivity.this.getResources().getColor(R.color.black));
                    English_MainActivity.this.death_card_maker_rip_setname4.setText(textView7.getText().toString());
                    English_MainActivity.this.death_card_maker_rip_setname5.setTextColor(English_MainActivity.this.getResources().getColor(R.color.black));
                    English_MainActivity.this.death_card_maker_rip_setname5.setText(textView9.getText().toString());
                    English_MainActivity.this.death_card_maker_rip_setnumber1.setTextColor(English_MainActivity.this.getResources().getColor(R.color.black));
                    English_MainActivity.this.death_card_maker_rip_setnumber1.setText(textView2.getText().toString());
                    English_MainActivity.this.death_card_maker_rip_setnumber2.setTextColor(English_MainActivity.this.getResources().getColor(R.color.black));
                    English_MainActivity.this.death_card_maker_rip_setnumber2.setText(textView4.getText().toString());
                    English_MainActivity.this.death_card_maker_rip_setnumber3.setTextColor(English_MainActivity.this.getResources().getColor(R.color.black));
                    English_MainActivity.this.death_card_maker_rip_setnumber3.setText(textView6.getText().toString());
                    English_MainActivity.this.death_card_maker_rip_setnumber4.setTextColor(English_MainActivity.this.getResources().getColor(R.color.black));
                    English_MainActivity.this.death_card_maker_rip_setnumber4.setText(textView8.getText().toString());
                    English_MainActivity.this.death_card_maker_rip_setnumber5.setTextColor(English_MainActivity.this.getResources().getColor(R.color.black));
                    English_MainActivity.this.death_card_maker_rip_setnumber5.setText(textView10.getText().toString());
                    English_MainActivity.death_card_maker_rip_click = true;
                    create.dismiss();
                } else {
                    textView2.setError("");
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        ...
        if (i == death_card_maker_rip_RESULT_LOAD_IMAGE && i2 == -1 && intent != null) {
            String[] strArr = {"_data"};
    ...
    public void onBackPressed() {
        if (this.death_card_maker_rip_bg_layout.getVisibility() == View.VISIBLE) {
            ...
            ((CardView) dialog.findViewById(R.id.tv_dialog_yes_sure)).setOnClickListener(new View.OnClickListener() { 
                @Override 
                public void onClick(View view) {
                    English_MainActivity.super.onBackPressed();
                }
            });
